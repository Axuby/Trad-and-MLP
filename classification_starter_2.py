...
import numpy as np
from sklearn.metrics import ConfusionMatrixDisplay, confusion_matrix, classification_report, f1_score, precision_recall_fscore_support, \
    accuracy_score
...
from utils_b import create_results_archive, generate_summary_report, print_dataset_results, \
    generate_comparative_visualizations, save_detailed_results, update_performance_summary, print_dataset_statistics, \
    create_results_directory, plot_training_curves_main, plot_visualizations, save_final_results, \
...
def process_subject(subject_idx, features, labels, subjects, dataset_type, model_type, use_lda):
    ...
    if model_type == 'traditional':
        ...
        # fet the precision, recall and f1
...
def classification(features, labels, subjects, dataset_type, model_type='traditional', use_lda=False):
    ...
    # Compile feature importance info as well
